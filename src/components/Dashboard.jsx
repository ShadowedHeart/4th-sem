...
// importing resources
import userImage from "../resources/images/defaultImage.jpg";
...
//importing lazy-loaded component
      ...
      <AppBar className="AppBar" position="fixed" open={drawerOpen}>
        <Toolbar>
          ...
          <Box className="AppBarText">
            <div className="AppBarTextIcon">{IconTitleMap[ActivePage]}</div>
            <div>{ActivePage}</div>
          </Box>
        </Toolbar>
        <Box className="Profile" sx={{ mr: 2 }}>
          ...
          >
            ...
            <MenuItem onClick={() => AvtarMenuClickHandler(0)}>
              Profile
            </MenuItem>
